...
puts 'This should be run immediately after installing the Metadata component, and while the default user (albert.einstein) and password have not been modified.'
puts 'You should docker-compose up the Metadata component to make the FDP active. It will configure the FDP that is running on localhost.'
puts 'During your installation, you will have set the port for the FDP. Put that port into the docker run command'
